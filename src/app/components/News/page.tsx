...
function News() {
    return (
        ...
        md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[2rem]'>
                {/* card 1 */}
                <div >
          <NewsCard image={N1.src}  date='June 6,2024' title='Whats New in Melbourne team'
                        height='h-[300px]' />
                     
                </div>
                {/* card2 */}
                <div>
                    <NewsCard image={N2.src} date='June 7,2024' title='Whats New in Richmond team'
                        height='h-[300px]' />
                </div>
                {/* card3 */}
                <div>
                    <NewsCard image={N3.src} date='June 8,2024' title='Whats New in West Coast team'
                        height='h-[300px]' />
                </div>
                {/* card4 */}
                <div>
                    <NewsCard image={N4.src} date='June 9,2024' title='Whats New in Essendon team'
                        height='h-[300px]' />
                </div>
            </div>
        </div>
